...
class User(db.Model):
    ...
    role = db.Column(db.Text, server_default='admin', nullable=False)  # Use server_default for DB-level default

    # Index for foreign key references
...
class AuditLog(db.Model): 
    ...
    timestamp = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)  # Use utcnow for consistency
...
class Room(db.Model):
    ...
    status = db.Column(db.Text, server_default='available', nullable=False)  # Use server_default
